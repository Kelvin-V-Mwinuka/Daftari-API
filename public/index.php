...
// Register routes
$website_routes = require __DIR__ . '/../app/Routes/website/routes.php';
$website_routes($app);

$auth_routes = require __DIR__ . '/../app/Routes/api/auth.php';
$auth_routes($app);

$journal_routes = require __DIR__ . '/../app/Routes/api/journals.php';
$journal_routes($app);
